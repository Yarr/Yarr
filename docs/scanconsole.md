...
- **-r ``<path>``** => Controller config : this config contains the information to select the right hardware controller (e.g. SPEC or emulator) and the configuration of the hardware controller.
