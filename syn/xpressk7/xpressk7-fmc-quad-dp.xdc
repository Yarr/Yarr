...
set_property DIFF_TERM 1 [get_ports {fe_data_n[0]}]
set_property DIFF_TERM 1 [get_ports {fe_data_p[0]}]
set_property DIFF_TERM 1 [get_ports {fe_data_n[1]}]
set_property DIFF_TERM 1 [get_ports {fe_data_p[1]}]
set_property DIFF_TERM 1 [get_ports {fe_data_n[2]}]
set_property DIFF_TERM 1 [get_ports {fe_data_p[2]}]
set_property DIFF_TERM 1 [get_ports {fe_data_n[3]}]
set_property DIFF_TERM 1 [get_ports {fe_data_p[3]}]
