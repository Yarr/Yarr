...
GOLDEN_FILE = "golden_analog.json"

#@pytest.mark.parametrize("chip_id", ["0x2008b", "0x2009a", "0x2009b", "0x200aa"])
def test_analog_scan(chip_label, chip_id, golden_image_path):
    ...
    #Create histogram
        ...
        plt.title(f"Histogram of Pixel Differences for Analog Scan {chip_label}_{chip_id}")
