...
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/lin_analogscan.json -p -m 0 -o $3
...
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/lin_tune_globalpreamp.json -t 6000 5.32 -p -m 0 -o $3
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/lin_retune_pixelthreshold.json -t $4 -p -m 0 -o $3
