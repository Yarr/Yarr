...
auto logger = logging::make_log("rd53bDataMergingCheck_4to1");

constexpr const char* COLOR_GREEN = "\033[32m";
constexpr const char* COLOR_RESET = "\033[0m";

void printHelp() {
       std::cout << "./bin/rd53bDataMergingCheck_4to1 [-h] [-r <hw_controller_file>] [-c <connectivity_file>] [-t <test_size>] [-s] [-n] [-v]\n\n"
              << "Options:\n"
...
int main(int argc, char **argv) {
    ...
    logger->info("Running data merging test for 4-to-1 data merging...");
