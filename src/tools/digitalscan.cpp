...
int main(void) {
    ...
    std::thread t1(analysis, 0, &digScan, &keeper);
    std::thread t2(analysis, 1, &digScan, &keeper);
/*    std::thread t3(analysis, 2, &digScan, &keeper);
    std::thread t4(analysis, 3, &digScan, &keeper);
    std::thread t5(analysis, 4, &digScan, &keeper);
    std::thread t6(analysis, 5, &digScan, &keeper);
    std::thread t7(analysis, 6, &digScan, &keeper);
    std::thread t8(analysis, 7, &digScan, &keeper);
    std::thread t9(analysis, 8, &digScan, &keeper);
    std::thread t10(analysis, 9, &digScan, &keeper);
    std::thread t11(analysis, 10, &digScan, &keeper);
    std::thread t12(analysis, 11, &digScan, &keeper);
    std::thread t13(analysis, 12, &digScan, &keeper);
    std::thread t14(analysis, 13, &digScan, &keeper);
    std::thread t15(analysis, 14, &digScan, &keeper);
    std::thread t16(analysis, 15, &digScan, &keeper);
