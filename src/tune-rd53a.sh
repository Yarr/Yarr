...
./bin/scanConsole -r $5 -c ${@:6} -s configs/scans/rd53a/std_analogscan.json -p -m 0
...
./bin/scanConsole -r $5 -c ${@:6} -s configs/scans/rd53a/diff_retune_globalthreshold.json -t $2 -p -m 0
./bin/scanConsole -r $5 -c ${@:6} -s configs/scans/rd53a/diff_retune_pixelthreshold.json -t $2 -p -m 0
