...
# Usage: ./doScan_rd53a.sh [-m <SerialNumber>*] [-s <ScanType>*] [-r <ControllerCfg>] [-n <ConnecitiityCfg>] [-i <EnvironmentalCfg>] [-c <TargetCharge>] [-t <TargetTot>] [-p <TargetPreamp>] [-M <mask>] [-d] [-l]
# * is required item
################################
