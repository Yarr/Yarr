...
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/diff_analogscan.json -p -m 1 -o $3
...
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/diff_tune_finepixelthreshold.json -t $4 -p -m 0 -o $3
