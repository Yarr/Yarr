...
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/diff_analogscan.json -p -m 0 -o $3
...
./bin/scanConsole -r $1 -c $2 -s configs/scans/rd53a/diff_tune_globalpreamp.json -t 7500 6.0 -p -m 0 -o $3
