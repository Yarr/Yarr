...
#define RX_ERROR_COUNTER_STOP_VALUE 0x8
#define RX_ERROR_COUNTER_MODE 0x9
#define RX_ERROR_COUNTER_TARGET 0xA
#define RX_ERROR_COUNTER_RESET_READ 0xB
#define RX_TOTAL_VALID_STREAM_COUNTER 0xC
