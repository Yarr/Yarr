...
TEST_CASE("LoopStatus UID", "[Yarr][LoopStatus]") {
  ...
  SECTION("Single Loop") { loops = std::vector<unsigned>{745}; }
  SECTION("Single Loop Maximum Iterations") {
    loops = std::vector<unsigned>{std::numeric_limits<unsigned>::max()};
  }
  SECTION("Multiple Loops") { loops = std::vector<unsigned>{745, 1234, 5678}; }
  SECTION("Maximum Loops") {
    loops = std::vector<unsigned>{75834, 4839, 19082, 39, 0, 2901, 5893, 123456};
  }
