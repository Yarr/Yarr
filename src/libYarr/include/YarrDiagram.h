...
struct Node {
  ...
  virtual void toJson(json&) const = 0;
};
...
class YarrDiagram {
  ...
  private:
    ...
    void addProcNodes(const BookEntry&, const DataProcessor&, const DataProcessor&, const std::vector<std::unique_ptr<DataProcessor>>&);
