...
## ---- to be splitted into an own script
...
./bin/scanConsole -r $r -c $c -s configs/scans/rd53a/syn_noisescan.json -p $3
./bin/scanConsole -r $r -c $c -s configs/scans/rd53a/lindiff_noisescan.json -p $3
