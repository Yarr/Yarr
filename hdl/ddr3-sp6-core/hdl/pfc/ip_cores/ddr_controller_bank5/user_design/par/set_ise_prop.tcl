...
xfile add "../rtl/ddr_controller_bank5.vhd"
...
xfile add "ddr_controller_bank5.ucf"
...
project set "Library Search Order" "../synth/ddr_controller_bank5.lso" -process "Synthesize - XST"
