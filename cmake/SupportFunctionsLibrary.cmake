...
if(EXTRACT_GIT_TAG STREQUAL "")
  message(STATUS "Failed to find git tag in ${CMAKE_CURRENT_SOURCE_DIR} using v0.0.0")
  set(YARR_VERSION_MAJOR "0" PARENT_SCOPE)
  set(YARR_VERSION_MINOR "0" PARENT_SCOPE)
  set(YARR_VERSION_PATCH "0" PARENT_SCOPE)
else()
