...
if(NOT (PC_LIBFABRIC_FOUND STREQUAL "IGNORE"))
  ...
  if((NOT LIBFABRIC_LIBRARIES) OR (NOT LIBFABRIC_INCLUDE_DIRS))
    find_path(LIBFABRIC_INCLUDE_DIRS NAMES rdma/fabric.h)
    find_library(LIBFABRIC_LIBRARIES   PATHS /usr/lib/x86_64-linux-gnu /usr/local/lib NAMES fabric NO_DEFAULT_PATH )

    if(LIBFABRIC_INCLUDE_DIRS AND LIBFABRIC_LIBRARIES)
